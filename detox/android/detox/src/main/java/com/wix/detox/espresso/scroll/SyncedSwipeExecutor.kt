...
private const val LOG_TAG = "DetoxSyncSwipeExec"
private val SCROLL_PRECISION = floatArrayOf(1f, 1f)

class SyncedSwipeExecutor(
        private val uiController: UiController,
        private val motionPeriodMS: Long)
    : SwipeExecutor {
    ...
    override fun startAt(touchX: Float, touchY: Float) {
        downEvent = MotionEvents.sendDown(uiController, floatArrayOf(touchX, touchY), SCROLL_PRECISION).down
